...
public:
  ...
  NodeHandle("~"){
    ...
    // Initialize the transform message quaternion
    transf_.transform.rotation.x = 0;
    transf_.transform.rotation.y = 0;
    transf_.transform.rotation.z = 0;
    transf_.transform.rotation.w = 1;
