...
Clone the [code repository](https://github.com/foxglove/tutorials/tree/main/datasets/EuRoC_MAV) for this tutorial. In a new python virtual environment, install the following dependencies:
```bash
